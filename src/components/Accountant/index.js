...
export default function Accountant() {
  ...
  const navList = [
    ...
    { label: 'Meal Purchase', name: 'mealPurchase' },
    { label: 'Consultation Purchase', name: 'consultationPurchase' },
  ]
  ...
  return (
    <>
      {/* <NavDrawer
        drawerItems={[
          { showText: 'Meal Purchase', connectedLink: 'mealPurchase' },
          {
            showText: 'Consultation Purchase',
            connectedLink: 'consultationPurchase',
          },
        ]}
