...
export default function MealpkgOrderHistory(props) {
  ...
  //   const handleReviewPlan = (mealPurchase) => {
  //     history.push({
  //       pathname: "/MealAddressMain",
  //       state: {
  //         id: mealPurchase.meal_plan.id,
  //         mealType: mealPurchase.meal_plan.type,
  //         meal: mealPurchase,
  //       },
  //     });
  //   };
        ...
        <div className="card Meal_plan_container">
          <div className="row">
            <div className="col-md-12 col-xs-12">
              <p className="title_meal_pkg">Meal Plan Subscription</p>
            </div>
            ...
            <div className="col-md-6 col-xs-12">
              ...
              <div className="menu_booster_container">
                ...
                <h6 className="subscriptionplan_subtitle">
                  {mealPurchase.duration.title}
                </h6>
              </div>
              ...
              <div className="menu_booster_container">
                ...
                <h6 className="remaining_days_subtitle">
                  {remainingDays(mealPurchase.end_date)}
                </h6>
              </div>

              <div className="menu_booster_container">
                <p className="address_title">Addresses:</p>
                <h6 className="address_subtitle">View Address</h6>
                {/* <h6 className="address_subtitle">
                  {mealPurchase.shipping_address_line1}
                </h6> */}
              </div>
            </div>
            ...
            <div className="col-md-4 col-xs-12 right_side_row_container">
              ...
              <div className="right_side_container_orderhistory">
                ...
                <h6 className="order_subtitle">
                  {orderDate(mealPurchase.created_at)}
                </h6>
              </div>
              ...
              <div className="col-md-3 col-xs-12 btn_container_orderhistory">
                ...
                >
                  <button className="btn btn-default renew_plan_btn">
                    Renew Plan
                  </button>
                </Link>
                <br></br>
